...
public class LocalizationManager : MonoBehaviour
{
    ...
    void InitializeDictionaries()
    {
        ...
        localizedEN = new Dictionary<string, string>
        {
            ...
            {"intro_roxa_1", "Precisa Tradução!"},
            {"intro_roxa_2a", "Precisa Tradução!"},
            {"intro_roxa_2b", "Precisa Tradução!"},
            {"intro_roxa_2c", "Precisa Tradução!"},
            {"intro_roxa_2d", "Precisa Tradução!"},
            {"pre_consequence_roxa", "Precisa Tradução!"},
            {"intro_rosa_1", "Precisa Tradução!"},
            {"intro_rosa_2a", "Precisa Tradução!"},
            {"intro_rosa_2b", "Precisa Tradução!"},
            {"intro_rosa_2c", "Precisa Tradução!"},
            {"intro_rosa_2d", "Precisa Tradução!"},
            {"pre_consequence_rosa", "Precisa Tradução!"},
            {"final_narrative_1", "Precisa Tradução!"},
            {"final_narrative_2", "Precisa Tradução!"},
            {"final_narrative_3", "Precisa Tradução!"},
            {"final_narrative_4", "Precisa Tradução!"},
            {"credits_full_text", "Precisa Tradução!"},
